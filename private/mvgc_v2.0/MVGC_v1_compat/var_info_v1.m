%% var_info_v1
%
% Display VAR information as returned by |var_to_autocov| (v1 compatible)
%
% <matlab:open('var_info_v1.m') code>
%
%% Syntax
%
%     acerr = var_info_v1(info,abort_on_error)
%
%% Arguments
%
...
function acerr = var_info_v1(info,abort_on_error)
...
if ~isnan(info.rho)
    fprintf('    multi-information : %f (uniform = %f)\n',info.mii,info.mmii);
end
