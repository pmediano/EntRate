...
mosel     = 'AIC';  % model order selection ('actual', 'AIC', 'BIC' or supplied numerical value)
...
if isnumeric(mosel) && isint(mosel), morder = mosel; fprintf('\n\tuser   = %d *** selected',morder); end
fprintf('\n');
...
var_info_v1(info,true); % report results (and bail out on error)
