%% tsdata_to_autocov_debias (DEPRECATED v2.0 - functionality integrated in 'tsdata_to_autocov')
%
...
%
% This (experimental) algorithm [2] attempts to reduce bias due to noisy mean
% estimation for small samples.
%
%% References
%
