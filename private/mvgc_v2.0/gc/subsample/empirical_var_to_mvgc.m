...
function FE = empirical_var_to_mvgc(A,SIG,m,N,x,y,H0,nsamps,mtrunc,decayfac,regmode,~,~) % v2.0 - last two parameters no longer required
...
for s = 1:nsamps
    ...
    FE(s) = ss_to_mvgc(AE1,CE,KE,SIGE,x,y);
