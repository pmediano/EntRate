...
% |V| from the autocovariance sequence |G| defined as [[ii_acseq.png]]
% by solving the Yule-Walker equations
%
% <<eq_yweqs.png>>
%
% (where  [[ii_Sigma.png]] = |V|). For a |q|-lag autocovariance sequence,
...
% possibilities. The likely cause is that something went wrong in
% <var_to_autocov.html |var_to_autocov|>, which is typically called prior to
% this function; check the results of the latter with a <var_info.html
% |var_info|> call.
%
%% References
%
...
function [AF,V] = autocov_to_var(G)
